                ...
                <section className="text-gray-600 body-font bg-yellow-400 ">
                    <div className="container mx-auto flex px-5 pt-16 md:flex-row flex-col items-center">
                        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16  md:mb-0 items-center text-center mx-10 ">
                            ...
                            <div className="flex w-full md:justify-start justify-center items-end p-4 bg-white rounded-lg ">
                                <div className="relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4 mx-16">
                                    <div className=' '>
                                ...
                                <Link to='/login'><button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Search</button></Link>
                            </div>
                            <br /><br />

                        </div>
                        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                            <img className="object-cover object-center rounded" alt="hero" src="https://i.ibb.co/n7L6Vqp/Image-Base.png" />
                        </div>
                    </div>
                </section>
            </div>
