    ...
    return (
        <div>
            ...
            <div class="text-center mb-10 border-black">
                ...
                <div className="container mx-auto flex  py-24 md:flex-row flex-col items-center px-20  bg-white">
                ...
                <div className="container mx-auto flex  py-24 md:flex-row flex-col items-center px-20  bottom-6">
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0  ">
                ...
                <div className="container mx-auto flex  py-24 md:flex-row flex-col items-center px-20  bottom-6 bg-white">
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0  ">
